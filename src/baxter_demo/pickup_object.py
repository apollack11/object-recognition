...
def testnode():
    ...
    if button_state == 1:
        ...
        # dreturn = [xb, yb, zsafe, 0.99, 0.01, 0.01, 0.01]
        ...
        # Turn off vision while Baxter moves
        use_vision_pub.publish(False)
...
if __name__ == '__main__':
    ...
    use_vision_pub = rospy.Publisher("use_vision",Bool,queue_size=10)
    use_vision_pub.publish(True)
    print "Ready to go!"
    rospy.spin()
